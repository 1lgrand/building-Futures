...
const errroLocation = (err) => {
  console.warn(
    `Impossibile prendere la posizione corrente (${err.code}): ${err.message}`
  );
...
navigator.geolocation.getCurrentPosition(successLocation, errroLocation, {
...
function setupMap(position) {
  const promise = new Promise((resolve, reject) => {
    mapboxgl.accessToken =
      "pk.eyJ1IjoibWFudWVsbWFubmEiLCJhIjoiY2wzdWE1ZzZ4MDBlYzNqbDgyazljbml3diJ9.D7lwXQ7YZ4sUBif0Yggcgw";
...
const renderMap = (map) => {
  ...
  fetch("./static/gpx/percorsoAlberoBello.gpx")
